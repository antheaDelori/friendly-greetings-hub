...
import { ALL_GENRES, type Book, type Genre } from "@/data/books";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://liberiamo2076.com/" },
      { property: "og:title", content: "Liberiamo la mente — Read or Perish" },
      { property: "og:description", content: "Biblioteca olografica indipendente. Libri, racconti, saggi e articoli pubblicati direttamente dagli autori." },
      { property: "og:image", content: "https://liberiamo2076.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Liberiamo la mente — Read or Perish" },
      { name: "twitter:description", content: "Biblioteca olografica indipendente. Libri, racconti, saggi e articoli pubblicati direttamente dagli autori." },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden scanlines">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 py-6 md:py-10 grid lg:grid-cols-12 gap-10 items-start relative">
          <div className="lg:col-span-7 fade-up">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              {isAuthor ? (
                ...
                <Link
                  to={isLoggedIn ? "/auth/profilo-autore" : "/auth/"}
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="glass p-10 md:p-14 hud-frame">
            ...
            {isAuthor ? (
              ...
              <Link to={isLoggedIn ? "/auth/profilo-autore" : "/auth/"} className="mt-8 inline-flex items-center gap-3 border border-cyan bg-cyan/10 text-cyan px-7 py-4 font-mono tracking-[0.22em] text-[11px] uppercase hover:bg-cyan hover:text-void hover:glow-cyan transition-all">
                ▸ {t("home.autoreBtn")}
              </Link>
            )}
          </div>
