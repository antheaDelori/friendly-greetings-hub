...
const TIPI = [
  ...
  "— Novelle —",
  "Novella breve", "Novella psicologica", "Novella fantastica", "Novella storica", "Novella di formazione",
  "— Poesia —",
  "Raccolta poetica", "Poesia lirica", "Poesia narrativa", "Haiku / Micropoesia", "Sonetti",
  "— Fumetto —",
  "Fumetto d'avventura", "Fumetto umoristico", "Manga / Graphic novel", "Fumetto fantastico", "Fumetto storico",
  "— Illustrato —",
  "Album illustrato", "Arte / Fotografia", "Natura / Paesaggi", "Cucina / Lifestyle", "Manualistica",
  "— —",
