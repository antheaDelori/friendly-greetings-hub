...
export const Route = createFileRoute("/community")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://liberiamo2076.com/community" },
      { property: "og:title", content: "Community — Liberiamo la mente" },
      { property: "og:description", content: "Recensioni, commenti, autori da seguire. La spina dorsale della biblioteca olografica." },
      { property: "og:image", content: "https://liberiamo2076.com/logo-liberiamo.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Community — Liberiamo la mente" },
      { name: "twitter:description", content: "Recensioni, commenti, autori da seguire. La spina dorsale della biblioteca olografica." },
