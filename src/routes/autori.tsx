...
export const Route = createFileRoute("/autori")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://liberiamo2076.com/autori" },
      { property: "og:title", content: "Autori — Liberiamo la mente" },
      { property: "og:description", content: "Elenco alfabetico di tutti gli autori presenti in biblioteca." },
      { property: "og:image", content: "https://liberiamo2076.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Autori — Liberiamo la mente" },
      { name: "twitter:description", content: "Elenco alfabetico di tutti gli autori presenti in biblioteca." },
