...
const GuidaAutoriRoute = GuidaAutoriRouteImport.update({
  id: '/autori',
  path: '/autori',
  getParentRoute: () => GuidaRoute,
} as any)
...
const AutoriSlugRoute = AutoriSlugRouteImport.update({
  id: '/autori_/$slug',
  path: '/autori/$slug',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/guida/libri-aperti': {
      ...
      path: '/libri-aperti'
      fullPath: '/guida/libri-aperti'
      preLoaderRoute: typeof GuidaLibriApertiRouteImport
      parentRoute: typeof GuidaRoute
    }
    '/guida/gestione': {
      id: '/guida/gestione'
    ...
    '/autori_/$slug': {
      id: '/autori_/$slug'
      path: '/autori/$slug'
      fullPath: '/autori/$slug'
      preLoaderRoute: typeof AutoriSlugRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/auth/registrazione': {
